...
namespace Younes_Entreprise
{
    public static class NombreEnLettres
    {
        ...
        /// <returns></returns>
        public static string ToLettres(this double Nombre, Pays LePays = Pays.France, Devise LaDevise = Devise.Euro)
        {
            ...
            {
                milliers = new[] { "Centime", "Millionième", "Milliardième" };
